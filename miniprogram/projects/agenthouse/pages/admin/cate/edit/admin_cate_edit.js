...
Page({
	...
	bindAddressTap: function (e) {
		AdminCateBiz.selectLocationCallback(this);
	},
	...
	_loadDetail: async function () {
		...
		this.setData({
			...
			formAddress: cate.CATE_ADDRESS,
			formAddressDetail: cate.CATE_ADDRESS_DETAIL,
		...
		try {
			...
			let callback = async () => {
				...
				let node = {
					...
					'CATE_OBJ': {
						'cate': dataHelper.getDataByKey(data.forms, 'mark', 'cate').val, 
						'line': dataHelper.getDataByKey(data.forms, 'mark', 'line').val, 
						'area': dataHelper.getDataByKey(data.forms, 'mark', 'area').val, 
					}
